// src/components/sections/contact/NewsletterSignup.tsx
          ...
          <div className="relative text-center max-w-2xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                type="submit"
                disabled={status === 'submitting'}
                className="group inline-flex items-center justify-center gap-2 px-6 py-3 bg-primary text-primary-foreground rounded-lg font-medium hover:bg-primary/90 transition-all disabled:opacity-50"
              >
                {status === 'submitting' ? (
                  <>
