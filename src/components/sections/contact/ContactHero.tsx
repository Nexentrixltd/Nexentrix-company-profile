...
const contactInfo = [
  {
    icon: Mail,
    title: 'Email Us',
    details: ['info.nexentrixltd@gmail.com'],
    action: 'mailto:info.nexentrixltd@gmail.com',
    color: 'from-blue-500/20',
  },
  {
    icon: Phone,
    title: 'Call Us',
    details: ['+234(0)9110468788', '+234(0)9133300572'],
    action: 'tel:+2349110468788',
    color: 'from-green-500/20',
  },
  {
    icon: MapPin,
    title: 'Visit Us',
    details: ['FCT, Abuja Nigeria'],
    action: '#',
